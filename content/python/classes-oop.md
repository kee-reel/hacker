...
Чтобы узнать более подробно перейди к отдельной [статье про наследование](/python-classes-inheritance).

### Инкапсуляция

Позволяет скрыть детали реализации.

Чтобы узнать более подробно перейди к отдельной [статье про инкапсуляцию](/python-classes-incapsulation).

### Полиморфизм

Позволяет единообразно работать с методами разных классов, наследованных от одного родительского класса.

Чтобы узнать более подробно перейди к отдельной [статье про полиморфизм](/python-classes-polymorphism).
