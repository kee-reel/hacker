...
Если ты знаешь Python, то в этой [статье](/python-web-server) я показываю как создать простой сервер, который может отдавать HTML страницы.

Если не знаешь, то никогда не поздно его изучить -- [вот статья-введение](/python-intro). Я пишу просто и интересно, тебе понравится!
