...
Нарисуй на бумаге или в онлайн-редакторе блок схему для следующей задачки (можешь опираться на блок-схему в начале статьи).

#### [](#header-4)Простенькая задачка на условия и выражения внутри них

С клавиатуры вводится число -- необходимо вывести текстом:

* "Чётное" -- если оно чётное
* "Нечётное" -- если оно нечётное
* "Ответ на главный вопрос жизни, вселенной и всего такого" -- если это число 42
