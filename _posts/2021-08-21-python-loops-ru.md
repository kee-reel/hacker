...
Чтобы пройти по значениям словаря, надо у словаря вызвать функцию values() (мы её упоминали в [статье про контейнеры](/python-containers-ru)):
...
Дальше мы рассмотрим [функции](/python-functions-ru) -- с помощью них ты сможешь разбить логику программы на отдельные блоки и меньше путаться при написании сложных программ.
